...
const Pagination = ({
  ...
  return (
    <ul className="h-[40px] text-slate-900 flex flex-wrap bg-slate-400 w-fit mx-auto my-10">
      ...
      <li
        className="py-2 px-2 border-[1px] border-slate-200 min-w-[40px] text-center cursor-pointer"
